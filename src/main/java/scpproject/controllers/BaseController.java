...
import scpproject.commands.SigninCommand;
...
public abstract class BaseController extends HttpServlet {
  ...
  protected static final String PROJECT_API = "/scp";

  /**
   * TODO надо подумать над этим Метод, возвращающий команду в зависимости от переданной команды в заголовке запроса
   *
   * @param req  запрос
   * @param resp ответ
